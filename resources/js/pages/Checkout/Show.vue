    ...
    <div class="mx-auto max-w-5xl space-y-8 px-4 py-8 md:py-12">
        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div class="space-y-8 lg:col-span-2">
                    ...
                    <Card>
                        ...
                        <CardContent class="space-y-4">
                            <div class="grid gap-2">
                                ...
                                <InputError
                                    :message="errors['billing.country_id']"
                                />
                            </div>
                            ...
                            <div class="grid gap-4 sm:grid-cols-2">
                                <div class="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        :default-value="
                                            billing?.first_name ?? undefined
                                        "
                                    />
                                    <InputError
                                        :message="errors['billing.first_name']"
                                    />
                                </div>
                                <div class="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        :default-value="
                                            billing?.last_name ?? undefined
                                        "
                                    />
                                    <InputError
                                        :message="errors['billing.last_name']"
                                    />
                                </div>
                            </div>
                            ...
                            <div class="grid gap-2">
                                ...
                                <Input
                                    ...
                                    :default-value="
                                        billing?.company_name ?? undefined
                                    "
                                />
                                <InputError
                                    :message="errors['billing.company_name']"
                                />
                            </div>
                            ...
                            <div class="grid gap-2">
                                ...
                                <Input
                                    ...
                                    :default-value="
                                        billing?.line_one ?? undefined
                                    "
                                />
                                <InputError
                                    :message="errors['billing.line_one']"
                                />
                            </div>

                            <div class="grid gap-2">
                                <Label for="billing_line_two"
                                ...
                                <Input
                                    ...
                                    :default-value="
                                        billing?.line_two ?? undefined
                                    "
                                />
                                <InputError
                                    :message="errors['billing.line_two']"
                                />
                            </div>
                            ...
                            <div class="grid gap-4 sm:grid-cols-2">
                                ...
                                <div class="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        :default-value="
                                            billing?.postcode ?? undefined
                                        "
                                    />
                                    <InputError
                                        :message="errors['billing.postcode']"
                                    />
                                </div>
                            </div>
                            ...
                            <div class="grid gap-2">
                                <Label for="billing_state"
                                    >Région (optionnel)</Label
                                >
                                <Input
                                    id="billing_state"
                                    name="billing[state]"
                                    :default-value="billing?.state ?? undefined"
                                />
                                <InputError
                                    :message="errors['billing.state']"
                                />
                            </div>
                            ...
                            <div class="grid gap-4 sm:grid-cols-2">
                                <div class="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        :default-value="
                                            billing?.contact_email ?? undefined
                                        "
                                    />
                                    <InputError
                                        :message="
                                ...
                                <div class="grid gap-2">
                                    <Label for="billing_contact_phone"
                                    ...
                                    <Input
                                        ...
                                        :default-value="
                                            billing?.contact_phone ?? undefined
                                        "
                                    />
                                    <InputError
                                        :message="
                                            errors['billing.contact_phone']
                                        "
                                    />
                                </div>
                            </div>
                    ...
                    <Card v-if="isShippable">
                        ...
                        <CardContent v-show="!shipToBilling" class="space-y-4">
                            <div class="grid gap-2">
                                ...
                                <InputError
                                    :message="errors['shipping.country_id']"
                                />
                            </div>
                            ...
                            <div class="grid gap-4 sm:grid-cols-2">
                                <div class="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        :disabled="shipToBilling"
                                        :default-value="
                                            shipping?.first_name ?? undefined
                                        "
                                    />
                                    <InputError
                                        :message="errors['shipping.first_name']"
                                    />
                                </div>
                                <div class="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        :disabled="shipToBilling"
                                        :default-value="
                                            shipping?.last_name ?? undefined
                                        "
                                    />
                                    <InputError
                                        :message="errors['shipping.last_name']"
                                    />
                                </div>
                            </div>
                            ...
                            <div class="grid gap-2">
                                ...
                                <Input
                                    ...
                                    :disabled="shipToBilling"
                                    :default-value="
                                        shipping?.company_name ?? undefined
                                    "
                                />
                                <InputError
                                    :message="errors['shipping.company_name']"
                                />
                            </div>
                            ...
                            <div class="grid gap-2">
                                ...
                                <Input
                                    ...
                                    name="shipping[line_one]"
                                    :disabled="shipToBilling"
                                    :default-value="
                                        shipping?.line_one ?? undefined
                                    "
                                />
                                <InputError
                                    :message="errors['shipping.line_one']"
                                />
                            </div>

                            <div class="grid gap-2">
                                <Label for="shipping_line_two"
                                    >Complément d'adresse (optionnel)</Label
                                >
                                <Input
                                    ...
                                    :disabled="shipToBilling"
                                    :default-value="
                                        shipping?.line_two ?? undefined
                                    "
                                />
                                <InputError
                                    :message="errors['shipping.line_two']"
                                />
                            </div>
                            ...
                            <div class="grid gap-4 sm:grid-cols-2">
                                <div class="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        :disabled="shipToBilling"
                                        :default-value="
                                            shipping?.city ?? undefined
                                        "
                                    />
                                    <InputError
                                        :message="errors['shipping.city']"
                                    />
                                </div>
                                <div class="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        :disabled="shipToBilling"
                                        :default-value="
                                            shipping?.postcode ?? undefined
                                        "
                                    />
                                    <InputError
                                        :message="errors['shipping.postcode']"
                                    />
                                </div>
                            </div>
                            ...
                            <div class="grid gap-2">
                                ...
                                />
                                <InputError
                                    :message="errors['shipping.state']"
                                />
                            </div>

                            <div class="grid gap-2">
                                <Label for="shipping_delivery_instructions"
                                ...
                                <InputError
                                    :message="
                                        errors['shipping.delivery_instructions']
                                    "
                                />
                            </div>
                            ...
                            <div class="grid gap-4 sm:grid-cols-2">
                                <div class="grid gap-2">
                                    <Label for="shipping_contact_email"
                                    ...
                                    <Input
                                        ...
                                        :disabled="shipToBilling"
                                        :default-value="
                                            shipping?.contact_email ?? undefined
                                        "
                                    />
                                    <InputError
                                        :message="
                                            errors['shipping.contact_email']
                                        "
                                    />
                                </div>
                                <div class="grid gap-2">
                                    <Label for="shipping_contact_phone"
                                        >Téléphone (optionnel)</Label
                                    >
                                    <Input
                                        ...
                                        :disabled="shipToBilling"
                                        :default-value="
                                            shipping?.contact_phone ?? undefined
                                        "
                                    />
                                    <InputError
                                        :message="
                                            errors['shipping.contact_phone']
                                        "
                                    />
                                </div>
                            </div>
                ...
                <Form
                    v-if="isShippable && shipping"
                    v-bind="saveShipping.form()"
                    v-slot="{
                        ...
                        <CardContent class="space-y-4">
                            <div class="space-y-3">
                                <label
                                    ...
                                    class="flex cursor-pointer items-start gap-3 rounded-lg border p-4 has-[:checked]:border-primary has-[:checked]:ring-1 has-[:checked]:ring-primary"
                                >
                                    <input
                                        type="radio"
                                    ...
                                    />
                                    <div
                                        class="flex flex-1 items-start justify-between gap-2"
                                    >
                                        <div>
                                            <div
                            ...
                            <InputError
                                :message="shippingErrors.shipping_option"
                            />
                ...
                <Card v-else-if="isShippable">
                    <CardContent
                        class="py-6 text-center text-sm text-muted-foreground"
                    >
                        Renseignez votre adresse de livraison pour voir les
                        options.
                    </CardContent>
                </Card>
            </div>
