<template>
    ...
    >
        ...
        <div class="p-5">
            ...
            <div
                class="mt-4 flex items-center justify-between border-t border-neutral-100 pt-4"
            >
                ...
                <button
                    class="rounded-lg bg-neutral-900 px-4 py-2 text-sm font-medium text-white transition hover:bg-neutral-700"
                >
                    Voir le produit
                </button>
            </div>
